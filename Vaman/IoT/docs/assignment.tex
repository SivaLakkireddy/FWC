...
\newpage
\section{Connections}
Connect the Vaman, 7447 ,two 7474 ICs and seven segment according to table 3.
\newline
{
\begin{table}[h]	
\centering
...
Vaman           & \multicolumn{1}{l|}{IO16} & \multicolumn{1}{l|}{IO17} & \multicolumn{1}{l|}{IO18} & IO19 & \multicolumn{1}{l|}{IO12} & \multicolumn{1}{l|}{IO13}  & \multicolumn{1}{l|}{IO14} & IO15 & \multicolumn{2}{c|}{IO22}          & \multicolumn{1}{l|}{}  & \multicolumn{1}{l|}{}  & \multicolumn{1}{l|}{}   &    \\ \hline
...
\begin{tabularx}{1.25\textwidth} { 
  ...
  \hline
  https://github.com/SivaLakkireddy/FWC/blob/main/Vaman/IoT/codes/src/main.cpp\\
  \hline
\end{tabularx}
